...
class ThemeGrid(QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        # self.ui.b.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Red_...?$', True))
        # self.ui.c.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Green_...?$', True))
        # self.ui.d.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Blue_...?$', True))
        # self.ui.e.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Orange_...?$', True))
        # self.ui.f.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Red_\d\d._W', True))
        # self.ui.g.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Green_\d\d._W', True))
        # self.ui.h.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Blue_\d\d._W', True))
        # self.ui.i.clicked.connect(lambda: toggleCheckBoxes(self, r'DarkWii_Orange_\d\d._W', True))
